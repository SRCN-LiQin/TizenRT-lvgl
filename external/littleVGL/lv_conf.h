...
#define LV_VDB_SIZE                                                          \
    (20 * LV_HOR_RES) /*Size of VDB in pixel count (1/10 screen size is good \
                         for first)*/
#define LV_VDB_ADR                                                          \
...
#define LV_REFR_PERIOD       20 /*50 Screen refresh period in milliseconds*/
...
/*Compiler settings*/
#define LV_ATTRIBUTE_TICK_INC    /* Define a custom attribute to `lv_tick_inc` \
                                    function */
#define LV_ATTRIBUTE_TASK_HANDLER    /* Define a custom attribute to \
                                        `lv_task_handler` function */
